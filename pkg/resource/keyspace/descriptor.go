...
const (
	FinalizerString = "finalizers.keyspaces.services.k8s.aws/Keyspace"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("keyspaces")
